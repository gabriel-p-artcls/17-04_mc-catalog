...
% \documentclass[referee,draft]{aa}
...
\begin{figure}
\centering
\includegraphics[width=\hsize]{as_RA_DEC.png}
...
default setting in \texttt{ASteCA}, several other techniques for CMD star
...
MPs rather than removing the stars randomly as  in B07.

\begin{figure}
\centering
\includegraphics[width=\hsize]{L62_DA_BF.png}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=\hsize]{errors_asteca.png}
...
\begin{figure*}
\includegraphics[width=2.\columnwidth]{as_vs_lit_S-LMC.png}
...
\begin{figure}
\centering
\includegraphics[width=\hsize]{as_vs_lit_mass.png}
...
\begin{figure}
\centering
\includegraphics[width=\hsize]{B48_DA.png}
...
\begin{figure*}
\includegraphics[width=2.\columnwidth]{cross_match_if.png}
\caption{\emph{Left}: Age comparison for DBs that used the isochrone fit
method vs. \texttt{ASteCA}, where $N$ is the number of clusters
...
fitting a two-dimensional Gaussian kernel.
...
{tab:databases}.
%
These DBs are separated into two groups: those in which the standard by-eye
isochrone fitting method was applied, i.e., P99, P00, C06, and G10; and those
in which integrated photometry was employed, i.e., H03, R05, and P12.
%
A total of 142 clusters from our sample could be cross-matched.
In those cases names were not available to perform the cross-match,  i.e., P00,
P99, and R05, we employed a 20 arcsec finding radius, centered on the equatorial
...
\begin{figure}
\centering
\includegraphics[width=\hsize]{cross_match_ip_ages.png}
...
\begin{figure*}
\centering
\includegraphics[width=2.\columnwidth]{age_mass_corr.png}
...
%
\begin{figure*}
\includegraphics[width=2.\columnwidth]{cross_match_ip_mass.png}
...
\begin{figure*}
\includegraphics[width=2.\columnwidth]{as_kde_maps0.png}
...
\begin{figure*}
\includegraphics[width=2.\columnwidth]{as_kde_maps1.png}
...
\begin{figure}
\centering
\includegraphics[width=\hsize]{AMR_asteca.png}
...
%
This research made use of the Python language v2.7~\citep{vanRossum_1995}
...
\begin{figure*}
\includegraphics[width=2.\columnwidth]{massclean_mass.png}
...
\begin{figure*}
\includegraphics[width=2.\columnwidth]{massclean_z.png}
...
\begin{figure*}
\includegraphics[width=2.\columnwidth]{mar_vs_par_isochs.png}
...
\begin{figure*}
\includegraphics[width=2.\columnwidth]{outliers_VS_asteca_0.png}
...
\begin{figure*}
\includegraphics[width=2.\columnwidth]{P99_VS_asteca_0.png}
...
\begin{figure*}
\includegraphics[width=2.\columnwidth]{P99_VS_asteca_1.png}
\caption{CMDs for the P99 database.}
\label{fig:DBs_P99_1}
\end{figure*}
\clearpage
...
\begin{figure*}
\includegraphics[width=2.\columnwidth]{P00_VS_asteca_0.png}
...
\begin{figure*}
\includegraphics[width=2.\columnwidth]{P00_VS_asteca_1.png}
\caption{CMDs for the P00 database.}
\label{fig:DBs_P00_1}
\end{figure*}
\clearpage
...
\begin{figure*}
\includegraphics[width=2.\columnwidth]{P00_VS_asteca_2.png}
\caption{CMDs for the P00 database.}
\label{fig:DBs_P00_2}
\end{figure*}
\clearpage
...
\begin{figure*}
\includegraphics[width=2.\columnwidth]{C06_VS_asteca_0.png}
...
\begin{figure*}
\includegraphics[width=2.\columnwidth]{C06_VS_asteca_1.png}
\caption{CMDs for the C06 database.}
\label{fig:DBs_C06_1}
\end{figure*}
\clearpage
...
\begin{figure*}
\includegraphics[width=2.\columnwidth]{C06_VS_asteca_2.png}
\caption{CMDs for the C06 database.}
\label{fig:DBs_C06_2}
\end{figure*}
\clearpage
...
\begin{figure}
\includegraphics[width=\columnwidth]{C06_VS_asteca_3.png}
\caption{CMDs for the C06 database.}
\label{fig:DBs_C06_3}
\end{figure}
\clearpage
...
\begin{figure*}
\includegraphics[width=2.\columnwidth]{G10_VS_asteca_0.png}
...
\begin{figure*}
\includegraphics[width=2.\columnwidth]{G10_VS_asteca_1.png}
\caption{CMDs for the G10 database.}
\label{fig:DBs_G10_1}
\end{figure*}
\clearpage
...
\begin{figure*}
\includegraphics[width=2.\columnwidth]{G10_VS_asteca_2.png}
\caption{CMDs for the G10 database.}
\label{fig:DBs_G10_2}
\end{figure*}
\clearpage
...
\begin{figure*}
\includegraphics[width=2.\columnwidth]{G10_VS_asteca_3.png}
\caption{CMDs for the G10 database.}
\label{fig:DBs_G10_3}
\end{figure*}
\clearpage
...
\begin{figure*}
\includegraphics[width=2.\columnwidth]{G10_VS_asteca_4.png}
\caption{CMDs for the G10 database.}
\label{fig:DBs_G10_4}
\end{figure*}
\clearpage
...
\begin{figure*}
\includegraphics[width=2.\columnwidth]{G10_VS_asteca_5.png}
\caption{CMDs for the G10 database.}
\label{fig:DBs_G10_5}
\end{figure*}
\clearpage
...
\begin{figure*}
\includegraphics[width=2.\columnwidth]{G10_VS_asteca_6.png}
\caption{CMDs for the G10 database.}
\label{fig:DBs_G10_6}
\end{figure*}
\clearpage
...
\begin{figure*}
\includegraphics[width=2.\columnwidth]{G10_VS_asteca_7.png}
\caption{CMDs for the G10 database.}
\label{fig:DBs_G10_7}
\end{figure*}
\clearpage
...
\begin{figure}
\centering
\includegraphics[width=\hsize]{G10_VS_asteca_8.png}
\caption{CMDs for the G10 database.}
\label{fig:DBs_G10_8}
\end{figure}
...
the AMR is noisy owing to the very small step of 0.01 dex used and the
...
when constructing a histogram, thereby bringing back the issue of binning.
We have two advantages here: first, we use Knuth's algorithm (see
Sect.~\ref{ssec:synth-match}) to obtain the optimal binning for our data;
second, the final AMR function is very robust to changes in the binning method
...
\begin{figure}
\centering
\includegraphics[width=\hsize]{AMR_literature.png}
