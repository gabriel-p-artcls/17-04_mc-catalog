...
def main(isochrone, e, d):
    ...
    if cmd_sel == 1:
        ...
        # For HST/ACS WFC system.
        #
        # A_F555W = 1.026*Av = 3.1806*E(B-V)
        # A_F814W = 0.586*Av
        # E(F555W-F814W) = 0.44*A_v =  1.364*E(B-V)
        #
        A_F555W = 3.1806 * e
        iso_moved = [np.array(isochrone[0]) + 1.364*e,
                     np.array(isochrone[1]) + d + A_F555W]
