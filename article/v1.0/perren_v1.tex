...
\begin{figure*}
\centering
\includegraphics[width=2.\columnwidth]{figures/age_mass_corr.png}
...
Sect.~\ref{ssec:synth-match}) to obtain the optimal binning for our data; second, the final AMR function is very robust to changes in the binning method
