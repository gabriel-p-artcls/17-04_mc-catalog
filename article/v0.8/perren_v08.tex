...
\textbf{Even though \texttt{ASteCA} corrects synthetic clusters using a
...
grow with estimated age, as expected (due to the mass-to-light ratio
...
\textbf{only in their faintest magnitudes~\citep[using a theoretical
completeness function similar to that presented in][]{Small_2013}}. As such,
their mass
estimations
will not suffer from the systematic underestimation seen in
Sect.~\ref{sssec:integ_photom_masses}.
%
