...
CLUSTER_INI=$CDIR"/massclean2.014/ini.files/cluster.ini"
KING_INI=$CDIR"/massclean2.014/ini.files/king.ini"
FIELD_INI=$CDIR"/massclean2.014/ini.files/field.ini"

# Change to code directory.
cd $CDIR"/massclean2.014"
...
sed -i "34s/.*/V         (1)/" $FIELD_INI
# Number of field stars.
sed -i "36s/.*/10000      (3)/" $FIELD_INI
# v No field stars.
#sed -i "36s/.*/2      (3)/" $FIELD_INI
# Minimum magnitude.
sed -i "37s/.*/23        (4)/" $FIELD_INI
# Maximum magnitude.
sed -i "38s/.*/12         (5)/" $FIELD_INI
...
METAL=('001' '004' '015' '030')
#AGES=('0700')
AGES=('0700' '0720' '0750' '0770' '0800' '0820' '0850' '0870' '0900' '0920' '0950' '0970')
#INIT_MASS=('500')
INIT_MASS=('500' '1000' '5000' '10000' '25000' '50000' '100000' '250000')
DIST=('50000')
AV=('0.05')
