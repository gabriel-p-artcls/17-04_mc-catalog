...
def get_ext_cl(cl_name):
    ...
    cl_exts = {
        ...
        'BS80': 0.036, 'B111': 0.022, 'H86-174': 0.080, 'K57': 0.116,
        'H86-85': 0.101, 'H86-87': 0.101, 'H86-76': 0.101, 'K55': 0.116,
        'B103': 0.065, 'K43': 0.058, 'B99': 0.065, 'NGC242': 0.101,
        'NGC241': 0.101, 'K61': 0.116, 'K63': 0.116, 'H86-97': 0.101,
        'H86-90': 0.101, 'HW52': 0.087, 'B55': 0.101, 'B134': 0.116,
        'SOGLE196': 0.101, 'L39': 0.101, 'B124': 0.072, 'H86-188': 0.080,
        'HW32': 0.036, 'BS75': 0.036, 'B48': 0.101, 'K47': 0.080,
        'H86-190': 0.080
    }
    ...
    try:
        ...
        # If list is empty, pass minimum extinction range.
        if not e_rs.any():
            e_rs = np.arange(0., 0.025, 0.005)
        ...
        smc = ['L4', 'L5', 'L6', 'L7', 'L19', 'L27', 'HW47', 'BS121', 'L35',
               ...
               'HW86',
               'BS80', 'B111', 'H86-174', 'K57', 'H86-85', 'H86-87', 'H86-76',
               'K55', 'B103', 'K43', 'B99', 'NGC242', 'NGC241', 'K61', 'K63',
               'H86-97', 'H86-90', 'HW52', 'B55', 'B134', 'SOGLE196', 'L39',
               'B124', 'H86-188', 'HW32', 'BS75', 'B48', 'K47', 'H86-190'
               ]
        ...
        print 'Cluster not in S/LMC'
        e_rs, d_rs = [], []
        flag_cl = False

    return flag_cl, e_rs, d_rs
