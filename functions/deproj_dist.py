...
def deproj_dist(coord,
    ...
    # print 'd_deg C05 = {:.12f}'.format(dep_dist_deg.degree)
    ...
    # dep_dist_deg_p = claria_2005_dep_dist(rho, phi_p, glx_PA, glx_incl)
    # print 'd_deg P15 = {:.12f}'.format(dep_dist_deg_p.degree)
    ...
    # # TEST. Replace rho by D*sin(rho) --> Equivalent to vdMC01.
    ...
    # print 'd_kpc XXX = {:.12f}'.format(dep_dist_kpc)
...
if __name__ == "__main__":
    ...
    xi = deproj_dist(ra_dec, pa, inc, cent, dist)
    print xi
