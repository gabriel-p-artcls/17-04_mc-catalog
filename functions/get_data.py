...
def get_amr_lit():
    ...
    with open(in_file) as f:
        ...
        for line in skip_comments(f):
            ...
            # Read coordinates.
            if ls[2] != '--':
                amr_PT98_t[0].append([float(_) for _ in [ls[2], ls[3]]])
            amr_PT98_t[1].append([float(_) for _ in [ls[0], ls[1]]])
    ...
    with open(in_file) as f:
        ...
        for line in skip_comments(f):
            ls = line.split()
            # Read coordinates.
            amr_lmc_G98[0].append(float(ls[0]))
            amr_lmc_G98[1].append(float(ls[1]))
    ...
    with open(in_file) as f:
        ...
        for line in skip_comments(f):
            ls = line.split()
            # Read coordinates.
            amr_lmc_C08[0].append(float(ls[0]))
            amr_lmc_C08[1].append(float(ls[1]))
    ...
    with open(in_file) as f:
        ...
        for line in skip_comments(f):
            ls = line.split()
            # Read coordinates.
            amr_smc_C08[0].append(float(ls[0]))
            amr_smc_C08[1].append(float(ls[1]))
    ...
    with open(in_file) as f:
        ...
        for line in skip_comments(f):
            ls = line.split()
            # Read coordinates.
            amr_lmc_HZ09[0].append(float(ls[0]))
            amr_lmc_HZ09[1].append(float(ls[1]))
    ...
    with open(in_file) as f:
        ...
        for line in skip_comments(f):
            ls = line.split()
            # Read coordinates.
            amr_lmc_R12[0].append(float(ls[0]))
            amr_lmc_R12[1].append(float(ls[1]))
    ...
    with open(in_file) as f:
        ...
        for line in skip_comments(f):
            ls = line.split()
            # Read coordinates.
            amr_smc_HZ04[0].append(float(ls[0]))
            amr_smc_HZ04[1].append(float(ls[1]))
    ...
    with open(in_file) as f:
        ...
        for line in skip_comments(f):
            ls = line.split()
            # Read coordinates.
            amr_smc_N09[0].append(float(ls[0]))
            amr_smc_N09[1].append(float(ls[1]))
    ...
    with open(in_file) as f:
        ...
        for line in skip_comments(f):
            ls = line.split()
            # Read coordinates.
            amr_smc_TB09_1[0].append(float(ls[0]))
            amr_smc_TB09_1[1].append(float(ls[1]))
            amr_smc_TB09_2[0].append(float(ls[0]))
            amr_smc_TB09_2[1].append(float(ls[2]))
            amr_smc_TB09_3[0].append(float(ls[0]))
            amr_smc_TB09_3[1].append(float(ls[3]))
    ...
    with open(in_file) as f:
        ...
        for line in skip_comments(f):
            ...
            # Read coordinates.
            if ls[0] != '--':
                amr_smc_C13_B[0].append(float(ls[0]))
                amr_smc_C13_B[1].append(float(ls[1]))
            amr_smc_C13_C[0].append(float(ls[2]))
            amr_smc_C13_C[1].append(float(ls[3]))
    ...
    with open(in_file) as f:
        ...
        for line in skip_comments(f):
            ls = line.split()
            # Read coordinates.
            amr_PG13_t[0].append([float(_) for _ in [ls[4], ls[6]]])
            amr_PG13_t[1].append([float(_) for _ in [ls[0], ls[2]]])
    ...
    with open(in_file) as f:
        ...
        for line in skip_comments(f):
            ...
            # Read coordinates.
            if ls[0] != '--':
                amr_lmc_M14_0[0].append(float(ls[0]))
                amr_lmc_M14_0[1].append(float(ls[1]))
                amr_lmc_M14_1[0].append(float(ls[2]))
                amr_lmc_M14_1[1].append(float(ls[3]))
            amr_lmc_M14_2[0].append(float(ls[4]))
            amr_lmc_M14_2[1].append(float(ls[5]))
